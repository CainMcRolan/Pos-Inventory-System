...
class PDF extends FPDF
{
   function __construct($orientation = 'P', $unit = 'mm', $size = 'A4')
   {
    ...
    function Header()
    {
        ...
        $this->Cell(0, 2, 'CRT Minimart Hourly Report', 0, 1, 'C');
        $this->Ln(1);
        // Date and time
        date_default_timezone_set('Asia/Manila');
    ...
    function SalesSummary()
    {
        ...
        $this->Cell(0, 2, 'Sales Summary: ' . $startHour . '-' . $endHour , 0, 1, 'C');
    ...
    function ItemizedSales(){
      ...
      // Table headers
      $headers = array('Time', 'Item', 'Qty', 'Total');
      $this->SetFont('Arial', '', 5);
      $this->Cell(10, 2, $headers[0], 1, 0, 'C');
      $this->Cell(18, 2, $headers[1], 1, 0, 'C');
      $this->Cell(10, 2, $headers[2], 1, 0, 'C');
      $this->Cell(14, 2, $headers[3], 1, 0, 'C');
      $this->Ln();
  
      // Fetch sales data
      $query_sales = "SELECT date, name, sold, cash_received FROM sale WHERE date BETWEEN '$startOfDay' AND '$endOfDay'";
      ...
      while ($row_sale = mysqli_fetch_assoc($result_sales)) {
          ...
          $this->Cell(18, 2, $item_name, 1, 0, 'C');
          $this->Cell(10, 2, $quantity_sold, 1, 0, 'C');
          $this->Cell(14, 2, '$' . number_format($total_cash, 2), 1, 0, 'C');
          $this->Ln();
      }
      $this->Ln(2);
   }
